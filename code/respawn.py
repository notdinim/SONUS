...
def draw():
    """This function draws the respawn screen, restarting level 1."""
    global screen
    global WIDTH
    global HEIGHT
    ...
    background = pygame.transform.scale(pygame.image.load("../graphics/landscape.jpg"), (1200, 704))
