...
def draw():
    """This function draws the respawn screen, restarting level 2."""
    global screen
    global WIDTH
    global HEIGHT
    ...
    background = pygame.transform.scale(pygame.image.load("../graphics/landscape2.jpg"), (1200, 704))
